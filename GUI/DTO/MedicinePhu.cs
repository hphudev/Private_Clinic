...
namespace DTO
{
    public class MedicinePhu : IdentifiableObjectPhu, IEquatable<MedicinePhu>
    {
        ...
        public bool Equals(MedicinePhu other)
        {
        ...
        public MedicinePhu(string ID, string name, int importedUnitPrice, string unitID,
