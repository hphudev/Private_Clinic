...
DROP DATABASE QUANLYPHONGMACHTU
GO
...
(
	...
	NGAYSINH SMALLDATETIME CHECK (NGAYSINH <= CAST(GETDATE() AS DATE) AND NGAYSINH IS NOT NULL), 
...
(
	...
	NGAYKHAMBENH SMALLDATETIME CHECK (NGAYKHAMBENH >= CAST(GETDATE() AS DATE) AND NGAYKHAMBENH IS NOT NULL), 
...
(
	...
	CONSTRAINT PRIMARYKEYTHUOC UNIQUE (TENTHUOC, MADONVITINH), 
	...
	BEGIN
		...
		SET SOBENHNHAN = (
							 ...
							 WHERE BN.MABENHNHAN = CT.MABENHNHAN 
								AND CONVERT([DATE], CTBCDOANHTHU.NGAYLAP) = CONVERT([DATE], CT.NGAYKHAMBENH)
						 )
	END
GO
...
AS
	BEGIN
		...
		SET DOANHTHU = (
						   ...
						   WHERE HD.MACTKB = CT.MACTKB AND 
							   CONVERT([DATE], CT.NGAYKHAMBENH) = CONVERT([DATE], CTBCDOANHTHU.NGAYLAP)
					   )
	END
GO
...
AS
	BEGIN
		PRINT('TRIGGER KIEMTRASOLUONGTON')
		IF ((
				SELECT T.SOLUONGTON
...
INSERT INTO THAMSO VALUES(N'Tiền khám', 30000)
GO

INSERT INTO THAMSO VALUES(N'Số bệnh nhân tối đa', 40)
GO

/*INSERT INTO CTPHIEUKB VALUES('CTPKB00001', 'PKB00001', 'T00001', 10, 'CD01', 0)

SELECT *
FROM THUOC

DELETE FROM CTPHIEUKB
WHERE MAPHIEUKB = 'PKB00001'*/